...
The README documents the architecture, the stack and the WhatsApp flow above; it records no
competition or client the project was built for, so none is claimed here.
