...
| 045 | 045-mcp-server-spec | MCP server ideation: a public, read-only Model Context Protocol server for portfolio context | complete | 2026-09-05 | 2026-09-05 | none | branch `docs/mcp-server-spec` |
